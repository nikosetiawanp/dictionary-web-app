  ...
  return (
    <div className="relative ml-auto">
      ...
      {open && (
        ...
        >
          {["Sans Serif", "Serif", "Mono"].map((font, index) => (
            <div
              key={index}
              className="flex px-4 py-2 rounded-sm hover:bg-[#e9e9e9] dark:hover:bg-[#2d2d2d] active:bg-[#e9e9e9] dark:active:bg-[#2d2d2d] hover:cursor-pointer"
            >
              <span className="text-[15px] md:text-[18px] font-bold text-primary-light dark:text-primary-dark">
                {font}
              </span>
            </div>
          ))}
